        ...
        <div className="flex flex-col">
            ...
            <div className="flex-1 overflow-hidden">
                {viewMode === 'split' && (
                    <div className="flex flex-col">
                        {/* 预览容器 */}
                        <div className="h-[600px] flex flex-col overflow-hidden border-t border-zinc-200 dark:border-zinc-800">
                ...
                {viewMode === 'preview' && (
                    <div className="h-[800px] flex flex-col overflow-hidden border-t border-zinc-200 dark:border-zinc-800">
                        <MarpPreview markdown={markdown} taskId={taskId} />
                    </div>
                )}
            </div>
